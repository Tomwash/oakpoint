                        ...
                        (
                            ...
                            FROM 
                            OPENROWSET(BULK 'oakpoint-data/streams/D34723/practices.json', DATA_SOURCE = 'OakpointDataV1', SINGLE_CLOB) AS AzureBlob 
                        ); 
                        ...
                        original.updated_at = '2020-05-18T02:47:10.580Z',
