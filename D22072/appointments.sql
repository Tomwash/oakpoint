...
FROM
    OPENROWSET(BULK 'oakpoint-data/D22072/appointments.json', DATA_SOURCE = 'OakpointDataV1', SINGLE_CLOB) AS AzureBlob 
                        );
...
MERGE appointments original
                        ...
                        original.updated_at = '2020-05-12T01:03:24.813Z',
