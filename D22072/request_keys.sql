                        ...
                        (
                            ...
                            FROM 
                            OPENROWSET(BULK 'oakpoint-data/streams/D22072/request_keys.json', DATA_SOURCE = 'OakpointDataV1', SINGLE_CLOB) AS AzureBlob 
                        ); 
                        ...
                        original.updated_at = '2020-05-18T02:26:31.236Z',
                        ...
                        WHEN MATCHED 
                            THEN UPDATE SET 
                            original.[col_http_code] = modified.[col_http_code],original.[col_http_code_desc] = modified.[col_http_code_desc],original.[col_allowed_methods] = modified.[col_allowed_methods],original.[col_allow_origin] = modified.[col_allow_origin],original.[col_api_version] = modified.[col_api_version],original.[col_href] = modified.[col_href],original.[col_api_description] = modified.[col_api_description],original.[col_parameters] = modified.[col_parameters],original.[col_apis] = modified.[col_apis],
                        original.updated_at = '2020-05-18T02:26:50.548Z',
                        original.office_id = 'D22072',
                        practice_name = ''
                        WHEN NOT MATCHED BY TARGET THEN
                        INSERT  
                        ...
                        WHEN MATCHED 
                            THEN UPDATE SET 
                            original.[col_http_code] = modified.[col_http_code],original.[col_http_code_desc] = modified.[col_http_code_desc],original.[col_allowed_methods] = modified.[col_allowed_methods],original.[col_allow_origin] = modified.[col_allow_origin],original.[col_api_version] = modified.[col_api_version],original.[col_href] = modified.[col_href],original.[col_api_description] = modified.[col_api_description],original.[col_parameters] = modified.[col_parameters],original.[col_apis] = modified.[col_apis],
                        original.updated_at = '2020-05-18T02:36:05.800Z',
                        original.office_id = 'D22072',
                        practice_name = ''
                        WHEN NOT MATCHED BY TARGET THEN
                        INSERT  
                        ...
                        WHEN MATCHED 
                            THEN UPDATE SET 
                            original.[col_http_code] = modified.[col_http_code],original.[col_http_code_desc] = modified.[col_http_code_desc],original.[col_allowed_methods] = modified.[col_allowed_methods],original.[col_allow_origin] = modified.[col_allow_origin],original.[col_api_version] = modified.[col_api_version],original.[col_href] = modified.[col_href],original.[col_api_description] = modified.[col_api_description],original.[col_parameters] = modified.[col_parameters],original.[col_apis] = modified.[col_apis],
                        original.updated_at = '2020-05-18T02:36:19.264Z',
                        original.office_id = 'D22072',
                        practice_name = ''
                        WHEN NOT MATCHED BY TARGET THEN
                        INSERT  
