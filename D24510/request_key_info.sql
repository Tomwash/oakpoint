                        ...
                        (
                            ...
                            FROM 
                            OPENROWSET(BULK 'oakpoint-data/streams/D24510/request_key_info.json', DATA_SOURCE = 'OakpointDataV1', SINGLE_CLOB) AS AzureBlob 
                        ); 
                        ...
                        original.updated_at = '2020-05-18T02:38:09.667Z',
