                        ...
                        (
                            ...
                            FROM 
                            OPENROWSET(BULK 'oakpoint-data/streams/D18336/kpis.json', DATA_SOURCE = 'OakpointDataV1', SINGLE_CLOB) AS AzureBlob 
                        ); 
                        ...
                        original.updated_at = '2020-05-18T02:22:19.893Z',
                        ...
                        WHEN MATCHED 
                            THEN UPDATE SET 
                            original.[col_href] = modified.[col_href],original.[col_category] = modified.[col_category],original.[col_key_performance_indicator] = modified.[col_key_performance_indicator],original.[col_displayname] = modified.[col_displayname],original.[col_type] = modified.[col_type],
                        original.updated_at = '2020-05-18T02:25:06.822Z',
                        original.office_id = 'D18336',
                        practice_name = 'west cary dental'
                        WHEN NOT MATCHED BY TARGET THEN
                        INSERT  
                        ...
                        WHEN MATCHED 
                            THEN UPDATE SET 
                            original.[col_href] = modified.[col_href],original.[col_category] = modified.[col_category],original.[col_key_performance_indicator] = modified.[col_key_performance_indicator],original.[col_displayname] = modified.[col_displayname],original.[col_type] = modified.[col_type],
                        original.updated_at = '2020-05-18T02:34:19.643Z',
                        original.office_id = 'D18336',
                        practice_name = 'west cary dental'
                        WHEN NOT MATCHED BY TARGET THEN
                        INSERT  
